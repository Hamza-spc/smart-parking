...
const ReservationModal = ({ parking, slots, reserving, onReserve, onClose }) => {
    ...
    const handleSubmit = () => {
        ...
        onReserve(selectedSlot, startTime + ':00', endTime + ':00')
    }

    const isValid = selectedSlot && startTime && endTime && startTime < endTime
            ...
            >
                ...
                <div className="sticky top-0 bg-white dark:bg-gray-800 px-6 pt-5 pb-4 border-b border-gray-100 dark:border-gray-700 z-10">
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className="text-lg font-bold text-gray-800 dark:text-white">Reserve Parking</h3>
                        ...
                        {startTime && endTime && startTime < endTime && (
                            ...
                            >
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm text-gray-600 dark:text-gray-300">Estimated cost</span>
                                </div>
