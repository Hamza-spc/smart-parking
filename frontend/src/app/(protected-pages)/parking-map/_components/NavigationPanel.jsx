            ...
            <AnimatePresence>
                {arrived && (
                    ...
                    >
                        ...
                        <p style={{ color: 'white', fontWeight: 700, fontSize: 18 }}>You have arrived!</p>
                ...
                <div style={{ padding: '8px 20px 16px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 10, marginBottom: 16 }}>
                        <div style={{
                            ...
                            <p style={{ fontSize: 10, color: '#9CA3AF', textTransform: 'uppercase', letterSpacing: 0.5 }}>Distance</p>
                            <p style={{ fontWeight: 700, fontSize: 15, color: '#111827', marginTop: 2 }}>
                                {distanceRemaining || '--'}
                            </p>
                        </div>
                        <div style={{
                            ...
                            <p style={{ fontSize: 10, color: '#9CA3AF', textTransform: 'uppercase', letterSpacing: 0.5 }}>ETA</p>
                            <p style={{ fontWeight: 700, fontSize: 15, color: '#111827', marginTop: 2 }}>
                                {durationRemaining || '--'}
                            </p>
                        </div>
                        <div style={{
                            ...
                            <p style={{ fontSize: 10, color: '#9CA3AF', textTransform: 'uppercase', letterSpacing: 0.5 }}>Slots</p>
                            <p style={{ fontWeight: 700, fontSize: 15, color: '#10B981', marginTop: 2 }}>
                    ...
                    >
                        {arrived ? 'Done — View Parking' : 'Cancel Navigation'}
                    </button>
                </div>
            </div>
        </motion.div>
